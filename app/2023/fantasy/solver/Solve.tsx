...
import fantasyModel from "../../../../2023/minizinc/fantasy.mzn";
import getDzn from "../../../../2023/minizinc/getDzn";
import parseResult from "../../../../2023/minizinc/parseResult";
...
const Solve = () => {
  ...
  useEffect(() => {
    MiniZinc.init({
      workerURL: `${window.location.origin}/minizinc-worker.js`,
    })
      .then(() => {
